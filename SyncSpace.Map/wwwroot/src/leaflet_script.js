...
! function(t, i) {
    ...
    var qi = {
        ...
        Ki = E.extend({
            ...
            createPane: function(t, i) {
                var e = si("div", "map-pane" + (t ? " map-" + t.replace("Pane", "") + "-pane" : ""), i || this._mapPane);
            ...
            _initLayout: function() {
                ...
                this._fadeAnimated = this.options.fadeAnimation && vt, ci(t, "map-container" + (bt ? " map-touch" : "") + (zt ? " map-retina" : "") + (it ? " map-oldie" : "") + (ct ? " map-safari" : "") + (this._fadeAnimated ? " map-fade-anim" : ""));
                var i = oi(t, "position");
                "absolute" !== i && "relative" !== i && "fixed" !== i && (t.style.position = "relative"), this._initPanes(), this._initControlPos && this._initControlPos()
            },
            _initPanes: function() {
                var t = this._panes = {};
                this._paneRenderers = {}, this._mapPane = this.createPane("mapPane", this._container), vi(this._mapPane, new k(0, 0)), this.createPane("tilePane"), this.createPane("shadowPane"), this.createPane("overlayPane"), this.createPane("markerPane"), this.createPane("tooltipPane"), this.createPane("popupPane"), this.options.markerZoomAnimation || (ci(t.markerPane, "map-zoom-hide"), ci(t.shadowPane, "map-zoom-hide"))
            },
            ...
            _onPanTransitionEnd: function() {
                _i(this._mapPane, "map-pan-anim"), this.fire("moveend")
            },
            ...
            _createAnimProxy: function() {
                var t = this._proxy = si("div", "map-proxy map-zoom-animated");
            ...
            _animateZoom: function(t, i, e, n) {
                this._mapPane && (e && (this._animatingZoom = !0, this._animateToCenter = t, this._animateToZoom = i, ci(this._mapPane, "map-zoom-anim")), this.fire("zoomanim", {
                    center: t,
                    zoom: i,
                    noUpdate: n
            ...
            _onZoomTransitionEnd: function() {
                this._animatingZoom && (this._mapPane && _i(this._mapPane, "map-zoom-anim"), this._animatingZoom = !1, this._move(this._animateToCenter, this._animateToZoom), M(function() {
                    this._moveEnd(!0)
                }, this))
            }
        });
    ...
    var Xi = S.extend({
        ...
        addTo: function(t) {
            ...
            return ci(i, "map-control"), -1 !== e.indexOf("bottom") ? n.insertBefore(i, n.firstChild) : n.appendChild(i), this._map.on("unload", this.remove, this), this
        },
        remove: function() {
    ...
    var Ji = Xi.extend({
            ...
            expand: function() {
                ci(this._container, "map-control-layers-expanded"), this._section.style.height = null;
                var t = this._map.getSize().y - (this._container.offsetTop + 50);
                return t < this._section.clientHeight ? (ci(this._section, "map-control-layers-scrollbar"), this._section.style.height = t + "px") : _i(this._section, "map-control-layers-scrollbar"), this._checkDisabledLayers(), this
            },
            collapse: function() {
                return _i(this._container, "map-control-layers-expanded"), this
            },
            _initLayout: function() {
                var t = "map-control-layers",
            ...
            _createRadioElement: function(t, i) {
                var e = '<input type="radio" class="map-control-layers-selector" name="' + t + '"' + (i ? ' checked="checked"' : "") + "/>",
            ...
            _addItem: function(t) {
                ...
                t.overlay ? ((i = document.createElement("input")).type = "checkbox", i.className = "map-control-layers-selector", i.defaultChecked = n) : i = this._createRadioElement("map-base-layers_" + m(this), n), this._layerControlInputs.push(i), i.layerId = m(t.layer), zi(i, "click", this._onInputClick, this);
    ...
    var Qi = Xi.extend({
        ...
        te = Xi.extend({
            ...
            onAdd: function(t) {
                for (var i in (t.attributionControl = this)._container = si("div", "map-control-attribution"), Oi(this._container), t._layers) t._layers[i].getAttribution && this.addAttribution(t._layers[i].getAttribution());
    ...
    var ee, ne = {
        ...
        ae = E.extend({
            ...
            _onDown: function(t) {
                var i, e;
                !t._simulated && this._enabled && (this._moved = !1, li(this._element, "map-zoom-anim") || ae._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((ae._dragging = this)._preventOutline && Pi(this._element), xi(), Xt(), this._moving || (this.fire("down"), i = t.touches ? t.touches[0] : t, e = bi(this._element), this._startPoint = new k(i.clientX, i.clientY), this._parentScale = Ti(e), zi(document, re[t.type], this._onMove, this), zi(document, se[t.type], this._onUp, this))))
            },
            _onMove: function(t) {
                var i, e;
                !t._simulated && this._enabled && (t.touches && 1 < t.touches.length ? this._moved = !0 : ((e = new k((i = t.touches && 1 === t.touches.length ? t.touches[0] : t).clientX, i.clientY)._subtract(this._startPoint)).x || e.y) && (Math.abs(e.x) + Math.abs(e.y) < this.options.clickTolerance || (e.x /= this._parentScale.x, e.y /= this._parentScale.y, Ri(t), this._moved || (this.fire("dragstart"), this._moved = !0, this._startPos = yi(this._element).subtract(e), ci(document.body, "map-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), ci(this._lastTarget, "map-drag-target")), this._newPos = this._startPos.add(e), this._moving = !0, z(this._animRequest), this._lastEvent = t, this._animRequest = M(this._updatePosition, this, !0))))
            },
            ...
            finishDrag: function() {
                for (var t in _i(document.body, "map-dragging"), this._lastTarget && (_i(this._lastTarget, "map-drag-target"), this._lastTarget = null), re) Si(document, re[t], this._onMove, this), Si(document, se[t], this._onUp, this);
    ...
    var ze = Me.extend({
        ...
        Se = S.extend({
            ...
            _setIconStyles: function(t, i) {
                ...
                t.className = "map-marker-" + i + " " + (e.className || ""), s && (t.style.marginLeft = -s.x + "px", t.style.marginTop = -s.y + "px"), o && (t.style.width = o.x + "px", t.style.height = o.y + "px")
            },
    ...
    var Ze = Se.extend({
            ...
            _detectIconPath: function() {
                var t = si("div", "map-default-icon-path", document.body),
        ...
        Ee = ie.extend({
            ...
            addHooks: function() {
                ...
                }, this).enable(), ci(t, "map-marker-draggable")
            },
            removeHooks: function() {
                this._draggable.off({
                    ...
                    drag: this._onDrag,
                    dragend: this._onDragEnd
                }, this).disable(), this._marker._icon && _i(this._marker._icon, "map-marker-draggable")
            },
            moved: function() {
        ...
        ke = Me.extend({
            ...
            _initIcon: function() {
                var t = this.options,
                    i = "map-zoom-" + (this._zoomAnimated ? "animated" : "hide"),
            ...
            _initInteraction: function() {
                var t;
                this.options.interactive && (ci(this._icon, "map-interactive"), this.addInteractiveTarget(this._icon), Ee && (t = this.options.draggable, this.dragging && (t = this.dragging.enabled(), this.dragging.disable()), this.dragging = new Ee(this), t && this.dragging.enable()))
            },
    ...
    var Ye = Ke,
        Xe = Me.extend({
            ...
            onAdd: function() {
                this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()), this.options.interactive && (ci(this._image, "map-interactive"), this.addInteractiveTarget(this._image)), this.getPane().appendChild(this._image), this._reset()
            },
            onRemove: function() {
            ...
            _initImage: function() {
                ...
                ci(i, "map-image-layer"), this._zoomAnimated && ci(i, "map-zoom-animated"), this.options.className && ci(i, this.options.className), i.onselectstart = a, i.onmousemove = a, i.onload = p(this.fire, this, "load"), i.onerror = p(this._overlayOnError, this, "error"), !this.options.crossOrigin && "" !== this.options.crossOrigin || (i.crossOrigin = !0 === this.options.crossOrigin ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t ? this._url = i.src : (i.src = this._url, i.alt = this.options.alt)
            },
            _animateZoom: function(t) {
        ...
        Je = Xe.extend({
            ...
            _initImage: function() {
                ...
                if (ci(i, "map-image-layer"), this._zoomAnimated && ci(i, "map-zoom-animated"), this.options.className && ci(i, this.options.className), i.onselectstart = a, i.onmousemove = a, i.onloadeddata = p(this.fire, this, "load"), t) {
    ...
    var $e = Xe.extend({
        _initImage: function() {
            ...
            ci(t, "map-image-layer"), this._zoomAnimated && ci(t, "map-zoom-animated"), this.options.className && ci(t, this.options.className), t.onselectstart = a, t.onmousemove = a
        }
    });
    var Qe = Me.extend({
            options: {
        ...
        tn = Qe.extend({
            ...
            _initLayout: function() {
                var t, i = "map-popup",
                    e = this._container = si("div", i + " " + (this.options.className || "") + " map-zoom-animated"),
    ...
    var en = Qe.extend({
        ...
        _initLayout: function() {
            var t = "map-tooltip " + (this.options.className || "") + " map-zoom-" + (this._zoomAnimated ? "animated" : "hide");
        ...
        _setPosition: function(t) {
            ...
            t = t.subtract(A(i, c, !0)).add(u).add(l), _i(n, "map-tooltip-right"), _i(n, "map-tooltip-left"), _i(n, "map-tooltip-top"), _i(n, "map-tooltip-bottom"), ci(n, "map-tooltip-" + r), vi(n, t)
        },
        _updatePosition: function() {
    ...
    Ki.include({
        ...
        openTooltip: function(t, i) {
            return this._tooltip && this._map && (i = this._tooltip._prepareOpen(this, t, i), this._map.openTooltip(this._tooltip, i), this._tooltip.options.interactive && this._tooltip._container && (ci(this._tooltip._container, "map-clickable"), this.addInteractiveTarget(this._tooltip._container))), this
        },
        closeTooltip: function() {
            return this._tooltip && (this._tooltip._close(), this._tooltip.options.interactive && this._tooltip._container && (_i(this._tooltip._container, "map-clickable"), this.removeInteractiveTarget(this._tooltip._container))), this
        },
    ...
    var on = Me.extend({
        ...
        _initContainer: function() {
            this._container || (this._container = si("div", "map-layer " + (this.options.className || "")), this._updateZIndex(), this.options.opacity < 1 && this._updateOpacity(), this.getPane().appendChild(this._container))
        },
        _updateLevels: function() {
            ...
            if (void 0 !== t) {
                ...
                var n = this._levels[t],
                    o = this._map;
                return n || ((n = this._levels[t] = {}).el = si("div", "map-tile-container map-zoom-animated", this._container), n.el.style.zIndex = i, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), a(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n
            }
        },
        _onUpdateLevel: a,
        _onRemoveLevel: a,
        ...
        _tileReady: function(t, i, e) {
            ...
            (e = this._tiles[n]) && (e.loaded = +new Date, this._map._fadeAnimated ? (mi(e.el, 0), z(this._fadeFrame), this._fadeFrame = M(this._updateOpacity, this)) : (e.active = !0, this._pruneTiles()), i || (ci(e.el, "map-tile-loaded"), this.fire("tileload", {
                tile: e.el,
                coords: t
    ...
    var hn = Me.extend({
            ...
            onAdd: function() {
                this._container || (this._initContainer(), this._zoomAnimated && ci(this._container, "map-zoom-animated")), this.getPane().appendChild(this._container), this._update(), this.on("update", this._updatePaths, this)
            },
            onRemove: function() {
        ...
        un = hn.extend({
            ...
            _handleMouseOut: function(t) {
                ...
                i && (_i(this._container, "map-interactive"), this._fireEvent([i], t, "mouseout"), this._hoveredLayer = null, this._mouseHoverThrottled = !1)
            },
            _handleMouseHover: function(t, i) {
                if (!this._mouseHoverThrottled) {
                    for (var e, n, o = this._drawFirst; o; o = o.next)(e = o.layer).options.interactive && e._containsPoint(i) && (n = e);
                    n !== this._hoveredLayer && (this._handleMouseOut(t), n && (ci(this._container, "map-interactive"), this._fireEvent([n], t, "mouseover"), this._hoveredLayer = n)), this._hoveredLayer && this._fireEvent([this._hoveredLayer], t), this._mouseHoverThrottled = !0, setTimeout(p(function() {
    ...
    var cn = function() {
        ...
        _n = {
            _initContainer: function() {
                this._container = si("div", "map-vml-container")
            },
            _update: function() {
            ...
            _initPath: function(t) {
                ...
                ci(i, "map-vml-shape " + (this.options.className || "")), i.coordsize = "1 1", t._path = cn("path"), i.appendChild(t._path), this._updateStyle(t), this._layers[m(t)] = t
            },
            _addPath: function(t) {
                var i = t._container;
        ...
        pn = hn.extend({
            ...
            _initPath: function(t) {
                ...
                t.options.className && ci(i, t.options.className), t.options.interactive && ci(i, "map-interactive"), this._updateStyle(t), this._layers[m(t)] = t
            },
            _addPath: function(t) {
    ...
    var gn = ie.extend({
        ...
        _onMouseMove: function(t) {
            this._moved || (this._moved = !0, this._box = si("div", "map-zoom-box", this._container), ci(this._container, "map-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
            var i = new I(this._point, this._startPoint),
                e = i.getSize();
            vi(this._box, i.min), this._box.style.width = e.x + "px", this._box.style.height = e.y + "px"
        },
        _finish: function() {
            this._moved && (ri(this._box), _i(this._container, "map-crosshair")), Jt(), wi(), Si(document, {
                contextmenu: Ni,
                mousemove: this._onMouseMove,
                mouseup: this._onMouseUp,
                keydown: this._onKeyDown
    ...
    var yn = ie.extend({
        addHooks: function() {
            ...
            this._draggable || (t = this._map, this._draggable = new ae(t._mapPane, t._container), this._draggable.on({
                ...
                drag: this._onDrag,
                dragend: this._onDragEnd
            }, this), this._draggable.on("predrag", this._onPreDragLimit, this), t.options.worldCopyJump && (this._draggable.on("predrag", this._onPreDragWrap, this), t.on("zoomend", this._onZoomEnd, this), t.whenReady(this._onZoomEnd, this))), ci(this._map._container, "map-grab map-touch-drag"), this._draggable.enable(), this._positions = [], this._times = []
        },
        removeHooks: function() {
            _i(this._map._container, "map-grab"), _i(this._map._container, "map-touch-drag"), this._draggable.disable()
        },
        moved: function() {
            return this._draggable && this._draggable._moved
        },
    ...
    var Pn = ie.extend({
        ...
        _onDown: function(t) {
            if (t.touches) {
                ...
                var i = t.touches[0],
                    e = i.target;
                this._startPos = this._newPos = new k(i.clientX, i.clientY), e.tagName && "a" === e.tagName.toLowerCase() && ci(e, "map-active"), this._holdTimeout = setTimeout(p(function() {
        ...
        _onUp: function(t) {
            ...
            clearTimeout(this._holdTimeout), Si(document, {
                touchmove: this._onMove,
                touchend: this._onUp
            }, this), this._fireClick && t && t.changedTouches && ((e = (i = t.changedTouches[0]).target) && e.tagName && "a" === e.tagName.toLowerCase() && _i(e, "map-active"), this._simulateEvent("mouseup", i), this._isTapValid() && this._simulateEvent("click", i))
        },
    ...
    var Ln = ie.extend({
        addHooks: function() {
            ci(this._map._container, "map-touch-zoom"), zi(this._map._container, "touchstart", this._onTouchStart, this)
        },
        removeHooks: function() {
            _i(this._map._container, "map-touch-zoom"), Si(this._map._container, "touchstart", this._onTouchStart, this)
        },
