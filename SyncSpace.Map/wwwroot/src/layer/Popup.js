...
export const Popup = DivOverlay.extend({
	...
	options: {
		...
		// `map-popup-scrolled` CSS class selector.
		maxHeight: null,
	...
	_initLayout() {
		const prefix = 'map-popup',
		    container = this._container = DomUtil.create('div', `${prefix} ${this.options.className || ''} map-zoom-animated`);
